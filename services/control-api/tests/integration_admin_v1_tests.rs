//! Integration tests for admin v1 operator endpoints (ADR-012 §S1).
//!
//! Covers all five audit-log invariants from ADR-012 §S1.6:
//!
...
//!
//! DB-backed tests skip when `RB_DATABASE_URL` is unset (same convention used
...
// ---------------------------------------------------------------------------
// DB-backed tests — §S1.6 audit invariants
// ---------------------------------------------------------------------------
