...
#[openapi(
    ...
    paths(
        ...
        auth_verify::resend_verification,
    ...
    components(
        schemas(
            ...
            auth_verify::ResendVerificationRequest,
            ...
            chat::sessions::ChatSessionSummary,
            chat::sessions::ListChatSessionsResponse,
